...
import { createPublisherApi } from '@/services/publisher/publisher.api'
...
} from '@/components/admin/data/manage-publisher/schema/publisher.schema'

interface CreatePublisherFormProps {
  onSuccess: () => void
}

export function CreatePublisherForm({ onSuccess }: CreatePublisherFormProps) {
  ...
  const mutation = useMutation({
    mutationFn: (values: CreatePublisherFormValues) => createPublisherApi(values),
    onSuccess: () => {
      toast.success(t('message.success.create', 'Thêm nhà xuất bản thành công!'))
