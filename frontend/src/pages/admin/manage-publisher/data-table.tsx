import { TrashPublisherDialog } from '@/components/admin/data/manage-publisher/trash/TrashPublisherDialog'
import { CreatePublisherDialog } from '@/components/admin/data/manage-publisher/create/CreatePublisherDialog'
...
import { PublisherStatus } from '@/defines/publisher.enum' // Cập nhật Enum
import {
  type ColumnDef,
  ...
  return (
    <>
      <div className='flex items-center gap-2 py-4'>
        <Input
          placeholder={t('filters.search', 'Tìm tên nhà xuất bản...')}
          // Đổi getColumn từ 'supplier' sang 'publisher'
